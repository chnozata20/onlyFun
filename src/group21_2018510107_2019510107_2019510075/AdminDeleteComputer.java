...
public class AdminDeleteComputer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminDeleteComputer frame = new AdminDeleteComputer();
	 ...
	 * @throws Exception
	 */
	public AdminDeleteComputer() throws Exception {
		...
		computer1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(0).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(0);
					cp.setVisible(true);
		...
		computer2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(1).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(1);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(2).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(2);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer3.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(3).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(3);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer4.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(4).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(4);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer5.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(0).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(5);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer6.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(6).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(6);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer7.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		computer8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ComputerPlace.computers.get(7).isAvailability()) {
					dispose();
					AdminDeleteComputerPanel cp = new AdminDeleteComputerPanel(7);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		computer8.setFont(new Font("Tahoma", Font.PLAIN, 16));

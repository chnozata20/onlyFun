...
public class AdminDeleteOkey extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminDeleteOkey frame = new AdminDeleteOkey();
	 ...
	 * @throws Exception
	 */
	public AdminDeleteOkey() throws Exception {
		...
		okey1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(0).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(0);
					cp.setVisible(true);
		...
		okey2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(1).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(1);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(2).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(2);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey3.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(3).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(3);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey4.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(4).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(4);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey5.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(0).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(5);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey6.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(6).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(6);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey7.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		okey8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (OkeyPlace.okeys.get(7).isAvailability()) {
					dispose();
					AdminDeleteOkeyPanel cp = new AdminDeleteOkeyPanel(7);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		okey8.setRolloverIcon(new ImageIcon(
				"C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_desktop (1).png"));
		okey8.setOpaque(false);
		okey8.setFont(new Font("Tahoma", Font.PLAIN, 16));

...
public class PlaystationPage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PlaystationPage frame = new PlaystationPage();
	...
	public PlaystationPage() {
		...
		btnNewButton_1_3_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				PlaystationPlacePage ppp = new PlaystationPlacePage();
				ppp.setVisible(true);
		...
		btnNewButton_1_1_1.setBounds(188, 458, 230, 99);
		...
		lblNewLabel_1_1_1.setBounds(56, 299, 149, 45);
		...
		lblNewLabel_1_1_1_2_5.setBounds(218, 299, 324, 45);
		...
		spinner.setBounds(128, 373, 77, 45);
		spinner.setOpaque(false);
		...
		lblNewLabel_1_1_1_2_5_1.setBounds(218, 373, 324, 45);

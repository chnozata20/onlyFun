...
public class AdminDeleteMovie extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminDeleteMovie frame = new AdminDeleteMovie();
	...
	public AdminDeleteMovie() {
		...
		movie1NameLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		movie1TimeLabel.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		movie1Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				AdminDeleteMoviePanel cp = new AdminDeleteMoviePanel(1);
				cp.setVisible(true);
		...
		movie2Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				AdminDeleteMoviePanel cp = new AdminDeleteMoviePanel(2);
				cp.setVisible(true);
				cp.setResizable(false);
			}
		});
		...
		movie3Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				AdminDeleteMoviePanel cp = new AdminDeleteMoviePanel(3);
				cp.setVisible(true);
				cp.setResizable(false);
			}
		});
		...
		movie4Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				AdminDeleteMoviePanel cp = new AdminDeleteMoviePanel(4);
				cp.setVisible(true);
				cp.setResizable(false);
			}
		});
		...
		movie3NameLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		movie3TimeLabel.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		movie2NameLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		movie2TimeLabel.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		movie4NameLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		movie4TimeLabel.setFont(new Font("Tahoma", Font.PLAIN, 12));

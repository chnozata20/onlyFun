...
public class BowlingPage extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BowlingPage frame = new BowlingPage();
	...
	public BowlingPage() {
		...
		btnNewButton_1_3_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				BowlingPlacePage bpp = new BowlingPlacePage();
				bpp.setVisible(true);
		...
		btnNewButton_1_1_1.setBounds(182, 448, 230, 99);
		...
		lblNewLabel_1_1_1_2_5.setBounds(218, 296, 324, 45);
		...
		spinner.setBounds(128, 368, 77, 45);
		spinner.setOpaque(false);
		...
		lblNewLabel_1_1_1_2_5_1.setBounds(218, 368, 324, 45);

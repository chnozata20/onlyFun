...
public class AdminDeletePlaystation extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminDeletePlaystation frame = new AdminDeletePlaystation();
	 ...
	 * @throws Exception
	 */
	public AdminDeletePlaystation() throws Exception {
		...
		playstation1.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation1.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(0).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(0);
					cp.setVisible(true);
		...
		btnNewButton_1_3_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				AdminDeletePage mp = new AdminDeletePage();
				mp.setVisible(true);
		...
		playstation2.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(1).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(1);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation2.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation2.setOpaque(false);
		playstation2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation3.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(2).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(2);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation3.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation3.setOpaque(false);
		playstation3.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation4.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(3).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(3);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation4.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation4.setOpaque(false);
		playstation4.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation5.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(4).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(4);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation5.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation5.setOpaque(false);
		playstation5.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation6.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(0).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(5);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation6.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation6.setOpaque(false);
		playstation6.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation7.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(6).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(6);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation7.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation7.setOpaque(false);
		playstation7.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		playstation8.setIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\playstation (1).png"));
		playstation8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (PlaystationPlace.playstations.get(7).isAvailability()) {
					dispose();
					AdminDeletePlaystationPanel cp = new AdminDeletePlaystationPanel(7);
					cp.setVisible(true);
					cp.setResizable(false);
				}
			}
		...
		playstation8.setRolloverIcon(new ImageIcon("C:\\Users\\chnoz\\eclipse-workspace\\group21_2018510107_2019510107_2019510075\\images\\black_playstation (1).png"));
		playstation8.setOpaque(false);
		playstation8.setFont(new Font("Tahoma", Font.PLAIN, 16));
